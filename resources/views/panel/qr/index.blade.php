                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 d-flex flex-column justify-content-center">
                            <div class="visible-print text-center menu-toggle d-none">
                                ...
                                <img src="data:image/png;base64, {!! base64_encode($qrCode) !!}" width="200" width="200">
                                <p class="mt-4">Escanea el código para ver tu menu.</p>
                                <a href="data:image/png;base64, {!! base64_encode($qrCode) !!}" type="button" class="btn btn-primary" download="QR">
                                    Descargar Codigo QR
                                </a>
                            </div>
