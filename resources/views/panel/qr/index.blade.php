                    ...
                    <div class="row">
                            ...
                            <div id="accordion" role="tablist">
                                ...
                                <div class="card mb-2">
                                    ...
                                    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo"
                                        data-parent="#accordion">
                                        <div class="card-body">
                                            <p class="text-muted text-center">Arrastra los elementos de la lista en el orden requerido.</p>
                        ...
                        <div class="col-sm-5 d-flex flex-column justify-content-center">
                            <div class="smartphone">
                                <div class="content">
                                    <iframe id="preview" class="w-100 h-100" src="{{ url('/menu?branch_id='.session()->get('branch')->id) }}">Your browser isn't
                                        compatible</iframe>
                                </div>
                            </div>
                        </div>
